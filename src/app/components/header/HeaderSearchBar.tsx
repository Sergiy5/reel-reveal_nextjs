    ...
    <div id="search movie">
      <form className={"relative flex w-fit mx-2"} onSubmit={handleSubmit}>
        <input
          ...
          className={`group flex-grow w-full font-light h-[38px] pl-[21px] pr-[54px] text-light text-base text-textColor bg-inputColor rounded-[20px]
        ...
        >
          <Icon
            ...
            width={24}
            height={24}
            className={`ml-auto mr-auto transition duration-200 text-textColor group-focus:h-0`}
          />
        </button>
      </form>
    </div>

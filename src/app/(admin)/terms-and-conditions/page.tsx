  ...
  return (
    <main className=" w-full md:w-[700px]">
      <div className="flex flex-col gap-6  ">
        ...
        <p>We are ReelReveal we registered in Kyiv, Ukraine.</p>
        <p>
          We operate the website{" "}
          <Link href="https://www.reel-reveal.club/">
        ...
        <p>
          ...
          films that match their preferences. Through interactive quizzes, users
          receive personalized movie recommendations. The platform also offers
          trailers and advanced movie search features via the TMDB API. Note
          that ReelReveal does not provide film streaming services. Currently in
          demo mode, the platform allows users to enjoy a freemium model, with a
          free version offering up to four quiz attempts and a paid plan for
          unlimited quizzes. Users can register via email or Google, while demo
          mode tracks quiz attempts through localhost to enable wider access
          without requiring registration
        </p>
        <p>
          You can contact us by email at info.reelreveal@gmail.com or by mail to
          __________, Kyiv, Ukraine.
        </p>
        <p>
        ...
        <div>
          <a href="#products">5. PURCHASES AND PAYMENT</a>
        </div>
        <div>
          <a href="#subscriptions">6. SUBSCRIPTIONS</a>
        </div>
        <div>
          <a href="#returnno">7. POLICY</a>
        </div>
        <div>
        ...
        <div>
          <a href="#ppno">13. PRIVACY POLICY</a>
        </div>
        <div>
        ...
        <div>
          <a href="#california">24. CALIFORNIA USERS AND RESIDENTS</a>
        </div>
        <div>
          <a href="#misc">25. MISCELLANEOUS</a>
        </div>
        <div>
      ...
      <div>
        ...
        <div>
          ...
          <span>
            ...
            <span>info.reelreveal@gmail.com</span>. If we ever grant you the
      ...
      <div>
        <div>
          ...
          <span data-type="if" id="d2d82ca8-275f-3f86-8149-8a5ef8054af6">
            ...
            <span data-type="close"></span> <span>(3)</span>
      ...
      <div>
        <span>
          We reserve the red through the Services. We may, in our sole
          discretion, limit or cancel quantities purchased per person, per
          houseess. We reserve the right to limit or prohibit orders that, in
      ...
      <div id="ip">
        ...
        <p>
          ...
          than as set out in this section or elsewhere in our Legal Terms,
          please address your request to:{" "}
          <a href="mailto:info.reelreveal@gmail.com">
            info.reelreveal@gmail.com
          </a>
      ...
      <div>
        ...
        <p>
          Subscription is not automatically renewed. You will receive an email
          asking if you would like to continue your subscription for a new
          period.
        </p>
      </div>
      <div>
          ...
          <span>
            <span>
              <span>
                ...
                and every identifiable ind ividual person in your Contributions
                to use the name or likeness of each and every such identifiable
                ind ividual person to enable inclusion and use of your
      ...
      <div data-type="if">
        ...
        <p>
          ...
          of Ukraine. ReelReveal and yourself irrevocably consent that the
          courts of Ukraine shall have exclusive jurisdiction to resolve any
        ...
        <div>
          <span>
            ...
            arbitration shall be Kyiv, Ukraine. The language of the proceedings
            shall be Ukraine. The governing law of these Legal Terms shall be
        ...
        <div>
          <span>
            ...
            Dispute between the Parties ind ividually. To the full extent
      ...
      <div data-type="if" id="475fffa5-05ca-def8-ac88-f426b238903c">
        <div data-type="conditional-block">
          ...
          >
            ...
            <span>5</span>) any overt harmful act toward any other user of the
        ...
        <div>
          ...
          <div id="misc">
            ...
            <div>
              ...
              <div>
                <strong>info.reelreveal@gmail.com</strong>
              </div>
            </div>
          </div>
        </div>

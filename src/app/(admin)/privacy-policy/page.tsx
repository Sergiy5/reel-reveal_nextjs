    ...
    <main className=" w-full md:w-[700px]">
      <div className="flex flex-col gap-6  ">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to ReelReveal, the software
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to ReelReveal.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to ReelReveal, accessible from{" "}
              <a
                href="https://www.reel-reveal.club/home"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.reel-reveal.club/home
              </a>
            </p>
          </li>
          <li>
